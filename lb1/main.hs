...
-- Питанння: 
--Які основні властивості функції у функціональному програмуванні?
--Основні властивості функції у функціональному програмуванні: детермінованість, відсутність побічних ефектів, посилальна прозорість, можливість передавати функції як аргументи та повертати як значення.

--Що таке чисті функції?
--Чисті функції — це функції, які при однакових вхідних даних завжди повертають однаковий результат і не мають побічних ефектів.

--Для чого використовується рекурсія у функціональному програмуванні?
--Рекурсія у функціональному програмуванні використовується для реалізації циклічних обчислень, оскільки замінює традиційні імперативні цикли і дозволяє працювати зі структурами даних, такими як списки, у природний спосіб.
